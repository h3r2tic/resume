...
\cventry{Apr~2011 -- Present}{Creative Assembly}{Alien: Isolation}{}{}{Architected and implemented algorithms for PS3, PS4, XBox 360, XBox One, and PC:%
\begin{itemize}%
...
\item Research, optimization, code maintenance, artist support, smaller features.
\end{itemize}}

\section{Personal projects}

\cventry{2013 -- Present}{Shuriken}{}{}{}{Graphics research playground:
\begin{itemize}
	\item Physically-based rendering, real-time reflections;
	\item Using OpenGL 4 and the Rust programming language.
\end{itemize}}

\cventry{2008 -- 2010}{Boxen}{}{}{}{Multi-player network programming playground:
\begin{itemize}
	\item Physics synchronization for characters and complex vehicles.
\end{itemize}}

\cventry{Oct~2007 -- Apr~2008}{Deadlock}{}{}{}{Multi-player FPS game and engine done for a university course:%
\begin{itemize}%
...
\cventry{2007 -- 2008}{Hybrid}{}{}{}{Immediate-Mode GUI toolkit for OpenGL:
\begin{itemize}
...
\cventry{Mar 2007}{DShade}{}{}{}{Software 3D renderer:
\begin{itemize}
...
\cventry{Jul~2012}{Develop Conference}{}{Brighton, UK}{}{Detailed multi-BRDF rendering via stencil masking for the PS3 and XBox 360.}%
